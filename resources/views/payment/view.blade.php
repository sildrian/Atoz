            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-11 col-md-offset-1">
                        <form class="form-horizontal" method="POST" action="{{ url('checkPay') }}">
                            {{ csrf_field() }}
                            <input type="hidden" name="id_user" value="{{ Auth::user()->id_users }}">
                            <h3><b>Pay your order</b></h3>
                            <div class="form-group">
                                <div class="col-md-8">
                                    <input  type="text" class="form-control" placeholder="Order no" name="order_number" value="{{ $orderNumber }}" required autofocus></input>
                                </div>
                            </div>
